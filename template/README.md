...
A template project for creating MCP Servers.
...
```bash
uv run template --cli-arg-1 "cli-arg-1" --cli-arg-2 "cli-arg-2" --cli-arg-3 "cli-arg-3"
```
    ...
    "mcp": {
        "servers": {
            "Template": {
                "command": "uvx",
                "args": [
                    "https://github.com/strawgate/py-mcp-collection.git#subdirectory=template",
                    "--cli-arg-1",
                    "cli-arg-1",
                    "--cli-arg-2",
                    "cli-arg-2",
